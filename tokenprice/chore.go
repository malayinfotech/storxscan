...
// Chore to save storx ticker price to local DB.
//
// architecture: Chore
type Chore struct {
	log     *zap.Logger
...
// NewChore creates new chore for saving storx ticker price to local DB.
...
// RunOnce gets the latest storx ticker price and saves it to the DB.
